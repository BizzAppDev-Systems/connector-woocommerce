!(function (n) {
    ...
    function (n, e, t) {
        (function () {
            var e = typeof window !== "undefined" ? window.jQuery : t(2);
            (n.exports.ThemeNav = {
                navBar: null,
                win: null,
                winScroll: !1,
                        ...
                        n(document)
                            .on("click", "[data-toggle='wy-nav-top']", function () {
                                n("[data-toggle='wy-nav-shift']").toggleClass("shift"),
                                    n("[data-toggle='rst-versions']").toggleClass(
                                        "shift"
                                    );
                            })
                            .on(
                                ...
                                function () {
                                    var t = n(this);
                                    n("[data-toggle='wy-nav-shift']").removeClass(
                                        "shift"
                                    ),
                                        n("[data-toggle='rst-versions']").toggleClass(
                                            "shift"
                            ...
                            .each(function () {
                                ...
                                (expand = n(
                                    ...
                                    expand.on("click", function (n) {
                                        return (
                                            e.toggleCurrent(t), n.stopPropagation(), !1
                                        );
                                    }),
                                    t.prepend(expand);
                            });
