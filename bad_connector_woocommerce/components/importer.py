...
class WooImporter(AbstractComponent):
    ...
    #     data = self.backend_adapter.read(self.external_id, **kwargs)
    ...
    #                 continue
    #             self.generate_lock(
    #                 external_id=external_id, model=model, export=False, **kwargs
    #             )
    ...
    #                 external_id=external_id, binding_model=model, **kwargs
    #             )
    ...
    #     if skip:
    #         return skip
    #     binding = self._get_binding(**kwargs)
...
class WooBatchImporter(AbstractComponent):
    ...
    def run(self, filters=None, force=False, job_options=None, data=None, **kwargs):
        ...
        print(data, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa print data")
        records = data.get("data", [])
        for record in records:
            external_id = record.get(self.backend_adapter._remote_ext_id_key)
            print(record, "apapapapapapapapaapapap")
