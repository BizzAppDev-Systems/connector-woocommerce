...
class BaseWooTestCase(tests.HttpCase, TransactionComponentCase):
    def setUp(self):
        ...
        self.woocommerce_product_payload = {
            ...
            "name": "product-21",
            "slug": "product-21",
            "permalink": "http://localhost/product/product-21/",
            ...
            "post_password": "",
            "_links": {
                "self": [{"href": "http://localhost/wp-json/wc/v3/products/382"}],
                "collection": [{"href": "http://localhost/wp-json/wc/v3/products"}],
            },
        }
        self.woocommerce_order_payload = {
            ...
            "currency_symbol": "$",
            "_links": {
                "self": [{"href": "http://localhost/wp-json/wc/v3/orders/369"}],
                "collection": [{"href": "http://localhost/wp-json/wc/v3/orders"}],
                "customer": [{"href": "http://localhost/wp-json/wc/v3/customers/1"}],
            },
        }
    ...
    def test_product_create_webhook(self):
        ...
        self.woocommerce_product_response = self.opener.post(
            url=f"{self.base_url}/{product_webhook_url}",
    ...
    def test_order_create_webhook(self):
        ...
        self.woocommerce_order_response = self.opener.post(
            url=f"{self.base_url}/{order_webhook_url}",
